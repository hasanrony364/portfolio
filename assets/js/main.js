...
//        
//        // magnific js
//        $('.project-ovellay a').magnificPopup({type:'image'});
//
//    
//    
...
//    screenTop js
    ...
    $('.scrollup').on('click',function () {
     ...
     // isotop js
        ...
        // magnific js
        $('.project-ovellay .popup').magnificPopup({type:'image'});
...
$('.responsive').on('click', function (e) {
    ...
    // HOME TYPED JS
      $(".element").typed({
        strings: [ "Mehedee","Mountaineer","Trekker","Traveller","Lecturer",],
        typeSpeed: 10,
        loop:true,
        backDelay: 2000
      });
...
//    $('.project-ovellay a').magnificPopup({
//        type:'image',
